...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-09-18 (commit fe86d6b). Confidence: 100%.Scope: standard index · template content · full Git. Missing or unavailable evidence is not a negative finding. Run `repowise update --full` to continue the model-backed upgrade (cost is previewed before generation).Machine-readable scope: `{"analysis": {"skipped": [], "unavailable": []}, "content_provenance": "template", "file_pages": {"configured_cap": null, "effective_cap": null, "eligible": 2, "generated": 2, "omitted": 0}, "git_commit_cap": 500, "git_history_coverage": {"complete_through_depth": 11, "deep_commits": 0, "deep_files": 0, "eligible_files": 4, "fallback_files": 0, "files_with_history": 3, "global_commits": 11, "per_file_limit": 500, "recent_files": 3, "retained_commits": 4, "unavailable_files": 0, "workers": 4}, "git_tier": "full", "provider": {"embedder": "ollama", "model": null, "model_cost_possible": false, "name": null, "reused": false}, "run_mode": "standard", "search": {"full_text": "available", "next_command": "repowise reindex", "semantic": "available"}, "upgrade": {"completed_stages": [], "next_stage": "generation", "retryable": true, "status": "pending"}, "version": 1}`
...
### Code health
Three co-equal signals: code health 10.0/10 avg (Excellent), hotspot health 10.0/10 (stable), worst `scripts/research/typesafe_smoke_test.py` at 10.0/10 · maintainability 10.0/10 · performance risk 0 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
