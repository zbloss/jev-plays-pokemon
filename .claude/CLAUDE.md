...
### Code health
Three co-equal signals: code health 9.87/10 avg (Excellent), hotspot health 9.87/10 (stable), worst `src/jev_plays_pokemon/navigation.py` at 9.15/10 · maintainability 9.82/10 · performance risk 0 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
